...
const createUserRecord = (username) => {
    audit.innerHTML += `
        <div class="data-user user-add-data">
            ...
            </svg> <p>Se ha creado un nuevo usuario: <b class="user-name-data">${username}</b></p> <p class="info-data">16/06/2024 14:02</p>
        </div>
    `;
};
...
const deleteUserRecord = (username) => {
    audit.innerHTML += `
        <div class="data-user user-delete-data">
            ...
            </svg> <p>Se ha eliminado el usuario: <b class="user-name-data">${username}</b></p> <p class="info-data">16/06/2024 14:10</p>
        </div>
    `;
};
...
const editUserRecord = (username) => {
    audit.innerHTML += `
        <div class="data-user user-edit-data">
            ...
            </svg> <p>Se han modificado los datos del usuario: <b class="user-name-data">${username}</b></p> <p class="info-data">16/06/2024 14:10</p>
        </div>
    `;
};